...
export default class TelefoneContatoRepository extends Connection
{
    ...
    public async Get(idContato: number, idTelefone: number): Promise<ReturnMessage<ReturnResultDB<TelefoneContatoDto[]>>>
    {
    ...
    public async Delete(idTelefoneContato: number): Promise<ReturnMessage<boolean>>
    {
