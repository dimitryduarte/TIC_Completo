...
export default class CandidaturaRepository extends Connection
{
    ...
    public async Get(idOportunidade: number, idContato: number ,idCandidatura: number): Promise<ReturnMessage<ReturnResultDB<CandidaturaDto[]>>>
    {
    ...
    public async Delete(idCandidatura: number): Promise<ReturnMessage<boolean>>
    {
