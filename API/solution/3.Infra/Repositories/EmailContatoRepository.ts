...
export default class EmailContatoRepository extends Connection
{
    ...
    public async Get(idContato: number, idEmail: number): Promise<ReturnMessage<ReturnResultDB<EmailContatoDto[]>>>
    {
    ...
    public async Delete(idEmailContato: number): Promise<ReturnMessage<boolean>>
    {
