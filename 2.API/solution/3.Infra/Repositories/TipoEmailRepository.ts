...
export default class TipoEmailRepository extends Connection
{
    ...
    public async Get(idTipoEmail: number): Promise<ReturnMessage<ReturnResultDB<TipoEmailDto[]>>>
    {
    ...
    public async Delete(idTipoEmail: number): Promise<ReturnMessage<boolean>>
    {
