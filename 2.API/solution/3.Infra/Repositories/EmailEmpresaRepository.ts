...
export default class EmailEmpresaRepository extends Connection
{
    ...
    public async Get(idEmpresa: number, idEmail: number): Promise<ReturnMessage<ReturnResultDB<EmailEmpresaDto[]>>>
    {
    ...
    public async Delete(idEmailEmpresa: number): Promise<ReturnMessage<boolean>>
    {
