...
export default class TelefoneEmpresaRepository extends Connection
{
    ...
    public async Get(idEmpresa: number, idTelefone: number): Promise<ReturnMessage<ReturnResultDB<TelefoneEmpresaDto[]>>>
    {
    ...
    public async Delete(idTelefoneEmpresa: number): Promise<ReturnMessage<boolean>>
    {
