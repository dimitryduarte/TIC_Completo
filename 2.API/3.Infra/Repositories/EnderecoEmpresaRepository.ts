...
export default class EnderecoEmpresaRepository extends Connection
{
    ...
    public async Get(idEmpresa: number, idEndereco: number): Promise<ReturnMessage<EnderecoEmpresaDto>>
    {
    ...
    public async Delete(idEnderecoEmpresa: number): Promise<ReturnMessage<null>>
    {
